...
<BasketIcon></BasketIcon>
    ...
    <View className="bg-[#EFDEBE] pt-8 flex-1">
      <ScrollView>
          {/* Header */}
          <View>
              <ScrollView horizontal={true} showsHorizontalScrollIndicator={false} scrollEventThrottle={200} decelerationRate="fast" pagingEnabled>
                  <Image
                      source={produit}
        ...
        <View className=" mt-7">
          <Text className="px-3 text-left text-[#7B420E]">
            {description}
          </Text>
        </View>
        ...
        <View style={[{justifyContent:'space-evenly', marginVertical:10}]}>
                <View className="flex-row items-center space-x-2 ">
                    ...
                    <TouchableOpacity onPress={addItemToBasket}>
                        <PlusCircleIcon fill="#4E1703" color="white" size={40} padingright/>
                    </TouchableOpacity>
                </View>
        </View>
      </View>
